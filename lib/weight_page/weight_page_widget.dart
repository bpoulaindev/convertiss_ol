          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Image.asset(
                    'assets/images/love_you_tons.png',
                    width: 250,
                    height: 250,
                    fit: BoxFit.cover,
                  ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  'Vous avez toujours rêvé de savoir combien vous pesiez en unité Ol ? Eh bien aujourd\'hui ce rêve devient réalité.',
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if ((textController.text != null) &&
                                  (textController.text != '')) {
                                message = await actions.buildWeightTweet(
                              ...
                              setState(() => FFAppState().lastValue =
                                  functions.updateLastValue('weight',
                                      double.parse(textController.text)));
                              setState(() => FFAppState().addToHistory(
                                  functions.updateHistory('weight',
                                      double.parse(textController.text))));
