          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Image.asset(
                    'assets/images/positive_red_arrow_presentation.png',
                    width: 250,
                    height: 250,
                    fit: BoxFit.cover,
                  ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  'Depuis l\'aube de l\'humanité, l\'homme a cherché à convertir sa taille en Ol...',
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if ((textController.text != null) &&
                                  (textController.text != '')) {
                                message = await actions.buildSizeTweet(
                              ...
                              setState(() => FFAppState().lastValue =
                                  functions.updateLastValue('size',
                                      double.parse(textController.text)));
                              setState(() => FFAppState().addToHistory(
                                  functions.updateHistory('size',
                                      double.parse(textController.text))));
